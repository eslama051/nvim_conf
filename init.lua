    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          vim.api.nvim_set_keymap('n', '<leader>ru', '<cmd>RemoveUnused<CR>', { noremap = true, silent = true })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        javascript = { 'prettier', 'rettierd', stop_after_first = true },
...
vim.keymap.set('n', '<leader>fe', function()
  local path = vim.fn.expand '%:p:h' -- Get the current directory from netrw
  local cmd = ''
  ...
  vim.fn.system(cmd)
end, { desc = 'Open current directory in file explorer' })
